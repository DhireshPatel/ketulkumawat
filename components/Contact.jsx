        ...
        <div className="contact-block">
          <div className="contact-info reveal">
            <div className="contact-item">
              <span className="contact-icon"><MdKeyboardArrowRight /></span>
              <div>
            ...
            <div className="contact-item">
              ...
              <div>
                ...
                <div className="contact-value">
                  <a href="https://www.linkedin.com/in/dr-ketul-kumawat-3b3591181/" target="_blank" rel="noopener">
          ...
          <div className="contact-cta reveal">
            <div className="cta-card">
              ...
              <p>Available for research collaborations, invited talks, academic partnerships, and mentoring opportunities in the field of Chemical Sciences.</p>
