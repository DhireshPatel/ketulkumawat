...
export default function MessageInput({ value, onChange, onSend, disabled }) {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: 'var(--ai-bg)', borderColor: 'var(--ai-border-color)' }}
    >
      <div
      ...
      >
        ...
        <textarea
          ...
          style={{ color: 'var(--ai-text)', maxHeight: 160 }}
        />
        ...
        <motion.button
          ...
          style={{ backgroundColor: 'var(--ai-accent)', color: 'var(--ai-accent-text)' }}
        >
      ...
      <div className="flex items-center justify-between px-1.5 mt-1.5">
        ...
        <span
          ...
          style={{ color: remaining < 100 ? '#c0392b' : 'var(--ai-text-muted)' }}
        >
