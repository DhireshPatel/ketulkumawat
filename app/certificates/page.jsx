...
const certificates = [
  ...
  },
  {
    ...
    name: "New Trends in Chemical Research",
    year: "29-30 Dec 2022",
    issuer: "S.U.S. Govt. College, Karnal",
    category: "workshop",
      ...
      <section id="certificates" style={{ background: "var(--section-bg)" }}>
        <div className="section-inner">
          ...
          <p className="section-sub">
            A curated collection of certifications, workshops, and research
            activities that reflect academic excellence, continuous learning,
