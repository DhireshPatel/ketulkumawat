...
const SERVICES = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M30 8L40 18L18 40L6 42L8 30L30 8Z"
          stroke="currentColor"
          strokeWidth="2.5"
          strokeLinejoin="round"
        />
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        />
        <path
          d="M21 6V19L9 39C8 41 9.5 43 12 43H36C38.5 43 40 41 39 39L27 19V6"
          stroke="currentColor"
          strokeWidth="2.5"
          strokeLinejoin="round"
        />
...
const WHY_HIRE_ME = [
  {
    ...
    desc: "Years of hands-on academic and laboratory research experience.",
  },
  {
    title: "Professional Scientific Writing",
    desc: "Clear, precise writing suited for peer-reviewed publication.",
  },
  {
    title: "Reliable Communication",
    desc: "Prompt replies and transparent updates at every stage.",
  },
  {
    title: "Confidential Projects",
    desc: "Your data and manuscripts are always handled with discretion.",
  },
  {
    title: "Affordable Pricing",
    desc: "Fair, transparent rates for students and institutions alike.",
  },
  {
    title: "On-Time Delivery",
    desc: "Deadlines are treated as commitments, not suggestions.",
  },
  {
    title: "Client Satisfaction",
    desc: "Revisions and feedback loops until you are fully satisfied.",
  },
  {
    title: "Quality Focus",
    desc: "Every deliverable is checked against academic rigor and accuracy.",
  },
];
...
const PROCESS_STEPS = [
  {
    ...
    desc: "Tell me about your project, topic and goals.",
  },
  {
    title: "Project Discussion",
    desc: "We discuss scope, references and expected outcome.",
  },
  {
    title: "Receive Quote",
    desc: "A transparent quote based on scope and timeline.",
  },
  {
    title: "Work Starts",
    desc: "Research, writing or analysis begins on schedule.",
  },
        ...
        <div className="hm-hero-inner">
          <div className="hm-hero-text">
            ...
            <p className="hm-hero-para">
              Professional research, scientific writing, data analysis,
              proofreading, patent drafting support, and chemistry tutoring
              tailored to your academic and research needs.
            </p>
            <div className="hm-hero-actions">
              <button
                className="hm-btn hm-btn-primary"
                onClick={() => scrollToId("hm-contact")}
              >
                Hire Me
              </button>
              <button
                className="hm-btn hm-btn-outline"
                onClick={() => scrollToId("hm-services")}
              >
                View Services
              </button>
            </div>
          ...
          <div className="hm-hero-visual" aria-hidden="true">
            ...
            >
              ...
              />
              <path
                d="M250 260 L250 320 Q250 335 265 335 Q280 335 280 320 L280 260 Z"
                fill="none"
                stroke="var(--gold)"
                strokeWidth="2.5"
              />
              ...
              />
              <path
                d="M255 295 L275 295 L280 320 Q280 330 265 330 Q250 330 250 320 Z"
                fill="var(--gold-light)"
                opacity="0.35"
              />
            ...
            {PROCESS_STEPS.map((step, idx) => (
              <div className="hm-timeline-item" key={step.title}>
                ...
                {idx < PROCESS_STEPS.length - 1 && (
                  <div className="hm-timeline-line" aria-hidden="true" />
                )}
              </div>
            ))}
          </div>
        ...
        <div className="hm-container hm-container-narrow">
          ...
          <div className="hm-faq-list">
            {FAQS.map((item, idx) => {
              ...
              return (
                <div
                  className={`hm-faq-item ${isOpen ? "hm-faq-open" : ""}`}
                  key={item.q}
                >
                  <button
      ...
      <section className="hm-cta">
        <div className="hm-container hm-cta-inner">
          ...
          <p className="hm-cta-para">
            Ready to collaborate on your next research or academic project? Get
            in touch today.
          </p>
          <div className="hm-hero-actions hm-cta-actions">
            ...
            <button
              className="hm-btn hm-btn-outline hm-btn-outline-dark"
              onClick={() => scrollToId("hm-contact")}
            >
              Contact Me
            </button>
        ...
        <div className="hm-container hm-container-narrow">
          ...
          {submitted ? (
            <div className="hm-form-success">
              Thank you! Your request has been noted. I will get back to you
              shortly.
            </div>
          ) : (
